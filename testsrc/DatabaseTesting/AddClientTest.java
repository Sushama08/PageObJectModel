...
import static com.invoiceplane.utilities.Conversion.*;
...
public class AddClientTest
{
    ...
    public void AddClientTest(String clientName,String clientsurname,String language,String streetadd1,String streetadd2,String city,String state,String zipcode,
                              ...
                              String webaddress,String vatid,String taxcode) throws ParseException, IOException, ClassNotFoundException, SQLException {
        ...
        expected.add(streetadd1);
        expected.add(streetadd2);
        expected.add(city);
        expected.add(state);
        ...
        String url="jdbc:mysql://localhost:3307/invoiceplane";
 ...
 /*        addClient.setTxtClientName("Rob");
    ...
    public Object[][] getData() throws IOException
    {
        ...
        Object[][] data=new Object[rowCount][18];
